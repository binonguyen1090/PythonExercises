...
select_upcase_keys({"make": "Tesla", "MODEL": "S", "Year": 2018, "SEATS": 4}) # => {"MODEL"=>"S", "SEATS"=>4}


select_upcase_keys({"DATE":"July 4th","holiday": "Independence Day", "type":"Federal"}) # => {"DATE"=>"July 4th"}